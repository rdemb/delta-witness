"""Deterministic sealed plan for the DW-001 development mechanism pilot."""
...
class DW001PilotError(DeltaWitnessError):
    """Raised when a development-pilot plan is unsafe or invalid."""
...
def verify_development_pilot_plan_document(
    ...
    errors.extend(
        _differences(expected, plan, context="development pilot plan")
    )
